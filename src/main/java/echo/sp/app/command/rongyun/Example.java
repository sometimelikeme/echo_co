package echo.sp.app.command.rongyun;

import echo.sp.app.command.rongyun.ApiHttpClient;
import echo.sp.app.command.rongyun.models.ChatroomInfo;
import echo.sp.app.command.rongyun.models.FormatType;
import echo.sp.app.command.rongyun.models.GroupInfo;
import echo.sp.app.command.rongyun.models.ImgMessage;
import echo.sp.app.command.rongyun.models.SdkHttpResult;
import echo.sp.app.command.rongyun.models.TxtMessage;
import echo.sp.app.command.rongyun.models.VoiceMessage;
...
public class Example {
	...
	public static void main(String[] args) throws Exception {
		...
		String key = "x18ywvqf8hpvc";
		String secret = "IREYlTgiaDsk";
...
//				new TxtMessage("我是刘大虎"), FormatType.json);
...
//		result = ApiHttpClient.publishSystemMessage(key, secret, "fromUserId",
//				toIds, new TxtMessage("你是我"), "pushContent",
//				"pushData", FormatType.json);
//		System.out.println("publishSystemMessage=" + result);
//
