...
CREATE TABLE T_TASKS(
	...
	CANT_CODE VARCHAR(20),--发布任务时所在城市地区码
	PRIMARY KEY (TASK_ID)
);
--竞标任务行表
...
CREATE TABLE T_USER_ABLITY(
	...
	ABLI_BUY_COUNT INT,--技能购买总量
	ABLI_COMMMENT INT DEFAULT 0,--评论量
	ABLI_POINT DECIMAL(4,2) DEFAULT 5.0,--技能综合评分
	ABLI_STATUS CHAR(2),--枚举：10-审核中,20-审核通过,30-审核未通过或者无效状态,40-删除状态
...
CREATE TABLE T_USER_ABLITY_COMMENTS(
	ABLI_ID VARCHAR(32) NOT NULL,--技能ID
	ABLI_ORDER_ID VARCHAR(32) NOT NULL,--技能ID
	USER_ID VARCHAR(32) NOT NULL,--评论人
	TOTAL_POINT DECIMAL(4,2),--单次评分
	COMENT_TITLE VARCHAR(32),
	COMMENT_DESC VARCHAR(256),
	...
	PRIMARY KEY (ABLI_ID,ABLI_ORDER_ID,USER_ID)
);
...
CREATE TABLE T_ABLITY_ORDERS(
	...
	COMM_STATUS CHAR(1) DEFAULT '0',--评价状态：1:已评价,0:未评价
	NOTE VARCHAR(256),--订单备注
	DONE_ICON1 VARCHAR(256),--完成图片
	DONE_ICON2 VARCHAR(256),--完成图片
	DONE_ICON3 VARCHAR(256),--完成图片
	DONE_ICON4 VARCHAR(256),--完成图片
