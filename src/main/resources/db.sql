...
CREATE TABLE T_USERS(
  ...
  USER_TYPE CHAR(2) NOT NULL,--10:默认用户；20-店铺；30：用户&店铺；40: 店铺城市代言：99-管理员
...
CREATE TABLE T_ORDERS(
	...
	ORDER_ALIAS_ID VARCHAR(32) NOT NULL,--订单别号 商品ID + 日期 + 用户ID / 研究16位唯一码？？？
	ITEM_ID INTEGER NOT NULL,--商品ID
	MERCHANT_ID VARCHAR(32) NOT NULL,--所属店铺ID
	USER_ID VARCHAR(32) NOT NULL,--消费者ID
	STATUS CHAR(2) NOT NULL,--订单状态：10-下单，20-付款，30-消费，40-取消，50-退单，60-结束
...
CREATE TABLE T_ORDERS_LINE(
	ORDER_ID VARCHAR(32) NOT NULL,--订单号
	QTY_SOLD DECIMAL(6,2) NOT NULL,--购买数量
	PAYMENT_TYPE CHAR(2) NOT NULL,--支付方式：10-支付宝，20-微信，30-银联
	PAYMENT_MONEY DECIMAL(9,2) NOT NULL,--付款总额
	CAPTCHA VARCHAR(32) NOT NULL,--验证码 验证号不能太长？？？
