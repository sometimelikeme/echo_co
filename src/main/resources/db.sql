...
CREATE TABLE T_USERS_EXPAND(
  ...
  TOTAL_ABLITY DECIMAL(7,3),--用户总能力值
  PRIMARY KEY(USER_ID)
);
...
CREATE TABLE T_TASKS(
	...
	TASK_PAID DECIMAL(7,6),--发布任务酬劳
	TASK_GET_PAID DECIMAL(7,6),--完成任务酬劳
...
CREATE TABLE T_USER_ABLITY(
	...
	ABLI_ASK_PAID DECIMAL(7,6),--技能酬劳
